...
export async function ensureHomepageDefaultsForClub(club: {
  id: string;
  slug: string;
  name: string;
        ...
        data: [
          {
            ...
            answer:
              "The club will inform you if conditions affect the experience and explain the available options.",
            sortOrder: 0,
          },
          {
            sectionId: faq.id,
            ...
            answer:
              "Arriving 15 to 20 minutes early is usually best unless the club says otherwise.",
            sortOrder: 1,
          },
          {
            sectionId: faq.id,
            ...
            answer:
              "Yes. Payments are processed through Stripe for a secure checkout experience.",
            sortOrder: 2,
          },
          {
            sectionId: faq.id,
            ...
            answer:
              "Yes. Once your booking is completed, your confirmation is shown immediately.",
            sortOrder: 3,
          },
        ],
      });
