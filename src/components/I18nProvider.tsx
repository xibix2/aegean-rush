...
const DICTS = {
  en: {
    ...
    "admin.stats.onlineRevenue": "Online income",
    "admin.stats.walkInRevenue": "Walk-in income",
    "admin.stats.averageBooking": "Average booking value",
    "admin.stats.averageBookingHint": "Gross revenue / completed bookings",
    "admin.stats.completedBookings": "completed bookings",
    "admin.stats.refundRate": "Refund rate",
    "admin.stats.refunded": "refunded",
    "admin.stats.exportPdf": "Export PDF",
    "admin.stats.groupedDaily": "Daily view",
    "admin.stats.groupedMonthly": "Monthly view",
    "admin.stats.sources.online": "Online",
    "admin.stats.sources.walkIn": "Walk-in",
    "admin.stats.status.paid": "Paid",
    "admin.stats.status.pending": "Pending",
    "admin.stats.status.cancelled": "Cancelled",
    "admin.stats.status.refunded": "Refunded",
    "admin.stats.labels.guests": "Guests",
    "admin.stats.charts.revenueBySource": "Income by booking source",
    "admin.stats.charts.revenueMix": "Online vs walk-in income",
    "admin.stats.charts.bookingStatus": "Booking status mix",
    "admin.stats.charts.bookingsAndGuests": "Bookings and guests over time",
    "admin.stats.charts.busiestWeekdays": "Busiest weekdays",
  ...
  el: {
    ...
    "stats.range.all": "Συνολικά",
    "stats.range.allTime": "Συνολικά",
    ...
    "admin.stats.onlineRevenue": "Έσοδα διαδικτύου",
    "admin.stats.walkInRevenue": "Έσοδα επί τόπου",
    "admin.stats.averageBooking": "Μέση αξία κράτησης",
    "admin.stats.averageBookingHint": "Μικτά έσοδα / ολοκληρωμένες κρατήσεις",
    "admin.stats.completedBookings": "ολοκληρωμένες κρατήσεις",
    "admin.stats.refundRate": "Ποσοστό επιστροφών",
    "admin.stats.refunded": "επιστράφηκαν",
    "admin.stats.exportPdf": "Εξαγωγή PDF",
    "admin.stats.groupedDaily": "Ημερήσια προβολή",
    "admin.stats.groupedMonthly": "Μηνιαία προβολή",
    "admin.stats.sources.online": "Διαδίκτυο",
    "admin.stats.sources.walkIn": "Επί τόπου",
    "admin.stats.status.paid": "Πληρωμένες",
    "admin.stats.status.pending": "Σε αναμονή",
    "admin.stats.status.cancelled": "Ακυρωμένες",
    "admin.stats.status.refunded": "Επιστροφές",
    "admin.stats.labels.guests": "Επισκέπτες",
    "admin.stats.charts.revenueBySource": "Έσοδα ανά πηγή κράτησης",
    "admin.stats.charts.revenueMix": "Διαδίκτυο έναντι επί τόπου",
    "admin.stats.charts.bookingStatus": "Κατάσταση κρατήσεων",
    "admin.stats.charts.bookingsAndGuests": "Κρατήσεις και επισκέπτες",
    "admin.stats.charts.busiestWeekdays": "Ημέρες με τη μεγαλύτερη κίνηση",
