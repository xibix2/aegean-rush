...
@media (prefers-reduced-motion: reduce) {
  .hero-anim { animation: none !important; }
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div
          className="hero-anim absolute inset-x-0 bottom-0 h-[30%] opacity-60 sm:h-[34%] sm:opacity-70"
          style={{
            background:
        ...
        <div
          className="hero-anim absolute left-1/2 top-0 h-full w-[120%] -translate-x-1/2 opacity-15 blur-2xl sm:opacity-20"
          style={{
            background:
        ...
        <div className="absolute inset-0 opacity-[0.07] mix-blend-screen sm:opacity-[0.09]">
          <div
      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        <div className="mb-3 inline-flex max-w-full items-center gap-2 rounded-full border border-white/12 bg-white/6 px-3 py-1.5 text-[10px] font-medium uppercase tracking-[0.14em] text-white/80 backdrop-blur-xl sm:mb-4 sm:px-4 sm:py-2 sm:text-[11px] sm:tracking-[0.18em]">
          <Sparkles className="size-3 shrink-0 text-pink-300 sm:size-3.5" />
          <span className="truncate">{resolvedBadgeText}</span>
        </div>

        <h1 className="text-[2rem] font-semibold leading-[1.04] tracking-tight sm:text-4xl md:text-5xl lg:text-6xl">
          <span className="block">{resolvedTitle}</span>
          <span className="mt-1 block bg-gradient-to-r from-cyan-200 via-white to-pink-300 bg-clip-text text-transparent sm:mt-1.5">
            {resolvedHighlightTitle}
          </span>
        </h1>

        <p className="mx-auto mt-3 max-w-2xl text-sm leading-6 text-white/72 sm:mt-4 md:text-base">
          {resolvedSubtitle}
        </p>
